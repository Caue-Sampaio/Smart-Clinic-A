...
<head>
    ...
    <style>
        ...
        /* Tabela moderna para fallback */
        .table-modern thead { background:#f1f5f9; }
        .table-modern th { color:#475569; }
    ...
    <div class="medico-card">
        <div class="medico-card-header">
            <?php if (!empty($med['foto'])): ?>
                <img src="<?= htmlspecialchars($med['foto']) ?>" alt="Foto" class="medico-avatar">
            <?php else: ?>
...
<div class="row">
    <div class="col-md-6 mb-3">
        <label class="form-label fw-500" style="color:#475569;">Instituição</label>
...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        <label class="form-label" style="color:#475569;">Foto URL</label>
        <input class="form-control" name="foto" value="<?= $action=='edit' ? htmlspecialchars($medico['foto']) : '' ?>" placeholder="https://..." style="border-radius:8px;border:1px solid #e2e8f0;padding:10px 12px;">
    </div>
</div>
<div class="mb-4">
